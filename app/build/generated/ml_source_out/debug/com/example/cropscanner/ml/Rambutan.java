...
public final class Rambutan {
  @NonNull
  private final Model model;

  private Rambutan(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "rambutan.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Rambutan newInstance(@NonNull Context context) throws IOException {
    return new Rambutan(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Rambutan newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Rambutan(context, options);
  }
