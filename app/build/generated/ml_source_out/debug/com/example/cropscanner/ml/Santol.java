...
public final class Santol {
  @NonNull
  private final Model model;

  private Santol(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "santol.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Santol newInstance(@NonNull Context context) throws IOException {
    return new Santol(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Santol newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new Santol(context, options);
  }
