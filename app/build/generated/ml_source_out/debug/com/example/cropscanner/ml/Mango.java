...
public final class Mango {
  ...
  private Mango(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "mango.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Mango newInstance(@NonNull Context context) throws IOException {
    return new Mango(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Mango newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new Mango(context, options);
  }
